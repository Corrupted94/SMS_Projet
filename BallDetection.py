...
import numpy as np
import os
import gpiotest2 as gpio
import time

#Une partie de code ne nous appartient pas voir crédit dans le rapport. Nous avons modifié le code d'origine pour implémenter les fonctions GPIO.
###################################################################################################
def main():
